...
<div id="menu" class="container-fluid main">
    ...
    <nav class="menu">
        ...
        <ul>
            <li class="well page"><h2><? echo T_("Form setup"); ?></h2>
                <ul>
                    <li><a class="btn btn-raised"
                           href="?page=pagetest.php"><? echo T_("Compatibility testing with queXF"); ?></a></li>
                    <li><a class="btn btn-raised"
                           href="?page=new.php">New Form</a></li>
                    <li><a class="btn btn-raised"
            ...
            <li class="well page"><h2><? echo T_("Users"); ?></h2>
                <ul>
                    <li><a class="btn btn-raised"
            ...
            <? if (ICR_ENABLED) { ?>
                <li class="well page"><h2><? echo T_("ICR"); ?></h2>
                    <ul>
                        <li><a class="btn btn-raised"
            ...
            <li class="well page"><h2><? echo T_("Output"); ?></h2>
                <ul>
                    <li><a class="btn btn-raised" href="?page=outputunverified.php"><? echo T_("Output data"); ?></a></li>
                    <li><a class="btn btn-raised"
                           href="?page=output.php"><? echo T_("Output data/ddi"); ?></a></li>
                </ul>
            </li>
            <li class="well page"><h2><? echo T_("Progress"); ?></h2>
                <ul>
                    <li><a class="btn btn-raised"
            ...
            <li class="well page"><h2><? echo T_("Clients"); ?></h2>
                <ul>
